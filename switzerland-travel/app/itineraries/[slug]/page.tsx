...
export default function ItineraryPage({
  ...
  return (
    <article className="mx-auto max-w-2xl px-5 py-16">
      ...
      <div className="mt-3 flex flex-wrap items-center gap-x-4 gap-y-1 font-mono text-[12px] text-ink/50">
        <span>適合對象：{itinerary.suitFor}</span>
        <span className="font-semibold text-rail">{itinerary.priceFrom}</span>
      </div>
      ...
      <div className="mt-14 rounded-md border border-stone/60 bg-white/50 p-6">
        ...
        <a
          ...
          className="focus-ring mt-4 inline-block font-mono text-[12px] text-rail hover:underline"
        >
          查看完整出團日期、航班與詳細報價 →
        </a>
      </div>
